package jmwania.weather.presentation.screens.main.components
...
@Composable
fun MainScreenMainComponent(screenState: MainScreenState) {
    Column(
        modifier = Modifier
            .fillMaxSize()
...
@Preview
@Composable
fun MainScreenMainComponentPreview() {
    WeatherAppTheme {
        MainScreenMainComponent(screenState = MainScreenState())
    }
}
